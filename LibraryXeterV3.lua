if (game:GetService("CoreGui")):FindFirstChild("Xeter") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Xeter:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(51, 153, 153);
...
function Update:Window(Config)
	assert(Config.Title and Config.SubTitle, "Missing Title or SubTitle");
	local WindowConfig = {
		Size = Config.Size,
	...
	local Xeter = Instance.new("ScreenGui");
	Xeter.Name = "Xeter";
	Xeter.Parent = game.CoreGui;
	Xeter.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Xeter;
	OutlineMain.ClipsDescendants = true;
	OutlineMain.AnchorPoint = Vector2.new(0.5, 0.5);
	OutlineMain.BackgroundColor3 = Color3.fromRGB(51, 153, 153);
	OutlineMain.BackgroundTransparency = 0.4;
	OutlineMain.Position = UDim2.new(0.5, 0, 0.45, 0);
	OutlineMain.Size = UDim2.new(0, 0, 0, 0);
	CreateRounded(OutlineMain, 10);
	...
	OutlineMain:TweenSize(UDim2.new(0, WindowConfig.Size.X.Offset + 3.5, 0, WindowConfig.Size.Y.Offset + 3.5), "Out", "Quad", 0, true);
	...
	NameHub.Text = Config.Title or "Xeter Hub";
	NameHub.TextSize = 20;
	...
	function CreateButton(title, callback)
		...
		Button.BackgroundColor3 = Color3.fromRGB(51, 153, 153);
	...
	CreateButton("Discord Xeter Hub", function()
	...
	UserInputService.InputChanged:Connect(function(Input)
		if Dragging and (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) then
			OutlineMain.Size = UDim2.new(0, math.clamp(Input.Position.X - Main.AbsolutePosition.X + 3.5, WindowConfig.Size.X.Offset + 3.5, math.huge), 0, math.clamp(Input.Position.Y - Main.AbsolutePosition.Y + 3.5, WindowConfig.Size.Y.Offset + 3.5, math.huge));
	...
	function uitab:T(text, img)
		...
		ResizeButton.MouseButton1Click:Connect(function()
			if defaultSize then
				...
				OutlineMain:TweenSize(UDim2.new(1, -10, 1, -10), "Out", "Quad", 0, true);
